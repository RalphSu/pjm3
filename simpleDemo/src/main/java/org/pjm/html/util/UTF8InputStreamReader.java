...
public class UTF8InputStreamReader extends java.io.Reader
{
	...
	private boolean mEncodingError;
	 ...
	 */
	public static java.io.Reader makeInputStreamReader(InputStream in,
			String encoding)
	...
	public int read() throws IOException
	{
		if (mEncodingError)
		{
			// Once we have an encoding error, keep throwing it forever.
			// Otherwise, some callers (e.g. InputStream.read(byte[])) might
			// swallow the first exception and keep going.
